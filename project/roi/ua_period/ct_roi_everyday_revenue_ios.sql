...
FROM
    ...
    INNER JOIN `blockpuzzle-f21e1.learnings_data_warehouse_ios.dim_dwd_action_userInfo_a` u 
    ON a.user_pseudo_id = u.user_pseudo_id
    AND u.first_day_geo.country in ('United States','United Kingdom','Germany','France','Russia','Japan','Brazil','Canada')
